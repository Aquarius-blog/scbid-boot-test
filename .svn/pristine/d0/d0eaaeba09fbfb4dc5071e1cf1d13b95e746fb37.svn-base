...
public class Product implements Serializable {
	...
	private String authCode;// 付款条码(当面付必填)
	private String productId;// 商品ID
	private String subject;// 订单名称(必填)
	private String body;// 商品描述(必填)
	private String totalFee;// 总金额(单位是分)(必填)
	private String outTradeNo;// 订单号(唯一)(必填)
	...
	private String undiscounAmount;// 打折金额
	...
	public String getUndiscounAmount() {
		return undiscounAmount;
	}

	public void setUndiscounAmount(String undiscounAmount) {
		this.undiscounAmount = undiscounAmount;
	}
